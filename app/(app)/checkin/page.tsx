  ...
  return (
    <div className="flex flex-col h-full">
      <div className="md:hidden">
        <TopBar
          title="チェックイン"
          right={<span className="text-[12px] text-[#9a9aa0] font-mono">履歴</span>}
        />
      </div>
      <div className="hidden md:block">
        <PcHeader title="チェックイン" sub="QRコードをスキャンしてポイントを獲得" />
      </div>
  ...
  return (
    <div className="flex flex-col h-full">
      <TopBar
        ...
        right={
          <button className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-[#f1f1f5] text-[14px]">
            ⚙
          </button>
        }
      />
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-4 pb-3">
          <div className="bg-white border-[1.5px] border-dashed border-[#1a1a1a] rounded-xl p-3.5 flex items-center gap-3 cursor-pointer hover:bg-[#fafafa] transition-colors">
            {/* Mini QR mock */}
